  ...
  return (
    <>
      ...
      <div className="max-w-screen-lg mx-auto px-6">
        ...
        <h3 className="text-large font-semibold mt-3 mb-2">
        ...
        <h4 className="text-medium font-semibold mt-2 mb-2">
        ...
        <ul className="list-disc list-inside mb-2 text-foreground-500">
          ...
          <li>
            <span className="font-semibold">Web Beacons.</span> Certain sections
