  ...
  return (
    <>
      ...
      <div className="max-w-screen-lg mx-auto px-6">
        ...
        <p className="text-foreground-500 mb-2">Last updated: January 20, 2024</p>
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">Interpretation and Definitions</h2>
        <h3 className="text-large font-semibold mt-3 mb-2">Interpretation</h3>
        <p className="text-foreground-500 mb-2">
          The words of which the initial letter is capitalized have meanings defined under the following conditions. The
          following definitions shall have the same meaning regardless of whether they appear in singular or in plural.
        </p>
        <h3 className="text-large font-semibold mt-3 mb-2">Definitions</h3>
        <p className="text-foreground-500 mb-2">For the purposes of this Privacy Policy:</p>
        <ul className="list-disc list-inside mb-2 text-foreground-500">
          <li>
            <span className="font-semibold">Account</span> means a unique account created for You to access our Service
            or parts of our Service.
          </li>
          <li>
            <span className="font-semibold">Affiliate</span> means an entity that controls, is controlled by or is under
          ...
          <li>
            ...
            &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Kreatli.
          </li>
          <li>
          ...
          <li>
            <span className="font-semibold">Country</span> refers to: Poland
          </li>
          <li>
          ...
          <li>
            <span className="font-semibold">Service Provider</span> means any natural or legal person who processes the
          ...
          <li>
            <span className="font-semibold">Third-party Social Media Service</span> refers to any website or any social
            network website through which a User can sign in or create an account to use the Service.
          </li>
          <li>
            <span className="font-semibold">Usage Data</span> refers to data collected automatically, either generated
            by the use of the Service or from the Service infrastructure itself (for example, the duration of a page
            visit).
          </li>
          <li>
            <span className="font-semibold">Website</span> refers to Kreatli, accessible from{' '}
            <Link href="https://kreatli.com/marketplace" rel="external nofollow noopener noreferrer" target="_blank">
              https://kreatli.com/
            </Link>
          </li>
          <li>
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">Collecting and Using Your Personal Data</h2>
        <h3 className="text-large font-semibold mt-3 mb-2">Types of Data Collected</h3>
        <h4 className="text-medium font-semibold mt-2 mb-2">Personal Data</h4>
        <p className="text-foreground-500 mb-2">
        ...
        <h4 className="text-medium font-semibold mt-2 mb-2">Usage Data</h4>
        <p className="text-foreground-500 mb-2">Usage Data is collected automatically when using the Service.</p>
        <p className="text-foreground-500 mb-2">
        ...
        <h4 className="text-medium font-semibold mt-2 mb-2">Tracking Technologies and Cookies</h4>
        <p className="text-foreground-500 mb-2">
        ...
        <ul className="list-disc list-inside mb-2 text-foreground-500">
          ...
          <li>
            ...
            opened an email and for other related website statistics (for example, recording the popularity of a certain
        ...
        <p className="text-foreground-500 mb-2">
          ...
          <Link href="https://www.termsfeed.com/blog/cookies/#What_Are_Cookies" target="_blank" rel="noreferrer">
            TermsFeed website
          </Link>{' '}
          article.
        </p>
        ...
        <h3 className="text-large font-semibold mt-3 mb-2">Use of Your Personal Data</h3>
        <p className="text-foreground-500 mb-2">The Company may use Personal Data for the following purposes:</p>
        <ul className="list-disc list-inside mb-2 text-foreground-500">
          <li>
            <span className="font-semibold">To provide and maintain our Service</span>, including to monitor the usage
            of our Service.
          </li>
          <li>
            <span className="font-semibold">To manage Your Account:</span> to manage Your registration as a user of the
            Service. The Personal Data You provide can give You access to different functionalities of the Service that
            are available to You as a registered user.
          </li>
          <li>
            <span className="font-semibold">For the performance of a contract:</span> the development, compliance and
            undertaking of the purchase contract for the products, items or services You have purchased or of any other
            contract with Us through the Service.
          </li>
          <li>
            <span className="font-semibold">To contact You:</span> To contact You by email, telephone calls, SMS, or
          ...
          <li>
            <span className="font-semibold">To provide You</span> with news, special offers and general information
          ...
          <li>
            <span className="font-semibold">For business transfers:</span> We may use Your information to evaluate or
            conduct a merger, divestiture, restructuring, reorganization, dissolution, or other sale or transfer of some
          ...
          <li>
            <span className="font-semibold">For other purposes</span>: We may use Your information for other purposes,
        ...
        <p className="text-foreground-500 mb-2">We may share Your personal information in the following situations:</p>
        <ul className="list-disc list-inside mb-2 text-foreground-500">
          <li>
            <span className="font-semibold">With Service Providers:</span> We may share Your personal information with
            Service Providers to monitor and analyze the use of our Service, to contact You.
          </li>
          <li>
            <span className="font-semibold">For business transfers:</span> We may share or transfer Your personal
            information in connection with, or during negotiations of, any merger, sale of Company assets, financing, or
            acquisition of all or a portion of Our business to another company.
          </li>
          <li>
            <span className="font-semibold">With Affiliates:</span> We may share Your information with Our affiliates,
          ...
          <li>
            <span className="font-semibold">With business partners:</span> We may share Your information with Our
            business partners to offer You certain products, services or promotions.
          </li>
          <li>
            <span className="font-semibold">With other users:</span> when You share personal information or otherwise
            interact in the public areas with other users, such information may be viewed by all users and may be
            publicly distributed outside. If You interact with other users or register through a Third-Party Social
            Media Service, Your contacts on the Third-Party Social Media Service may see Your name, profile, pictures
            and description of Your activity. Similarly, other users will be able to view descriptions of Your activity,
            communicate with You and view Your profile.
          </li>
          <li>
            <span className="font-semibold">With Your consent</span>: We may disclose Your personal information for any
            other purpose with Your consent.
          </li>
        </ul>
        <h3 className="text-large font-semibold mt-3 mb-2">Retention of Your Personal Data</h3>
        <p className="text-foreground-500 mb-2">
        ...
        <h3 className="text-large font-semibold mt-3 mb-2">Transfer of Your Personal Data</h3>
        <p className="text-foreground-500 mb-2">
        ...
        <h3 className="text-large font-semibold mt-3 mb-2">Delete Your Personal Data</h3>
        <p className="text-foreground-500 mb-2">
        ...
        <h3 className="text-large font-semibold mt-3 mb-2">Disclosure of Your Personal Data</h3>
        <h4 className="text-medium font-semibold mt-2 mb-2">Business Transactions</h4>
        <p className="text-foreground-500 mb-2">
        ...
        <h4 className="text-medium font-semibold mt-2 mb-2">Law enforcement</h4>
        <p className="text-foreground-500 mb-2">
        ...
        <h4 className="text-medium font-semibold mt-2 mb-2">Other legal requirements</h4>
        <p className="text-foreground-500 mb-2">
        ...
        <h3 className="text-large font-semibold mt-3 mb-2">Security of Your Personal Data</h3>
        <p className="text-foreground-500 mb-2">
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">Links to Other Websites</h2>
        <p className="text-foreground-500 mb-2">
        ...
        <p className="text-foreground-500 mb-2">
          Kreatli&apos;s use and transfer to any other app of information received from Google Accounts will adhere to{' '}
          <Link
        ...
        <ul className="list-disc list-inside mb-2 text-foreground-500">
          <li>By email: support@kreatli.com</li>
        </ul>
      </div>
    </>
  );
