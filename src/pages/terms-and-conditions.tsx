    ...
    <>
      ...
      <div className="max-w-screen-lg mx-auto px-6">
        ...
        <p className="text-foreground-500 mb-2">
          ...
          prevailing law of pl. Any use of the above terminology or other words in the singular, plural, capitalization
        ...
        <p className="text-foreground-500 mb-2">
          ...
          areas of the website. kreatli.com does not filter, edit, publish or review Comments prior to their presence on
          the website. Comments do not reflect the views and opinions of kreatli.com,its agents and/or affiliates.
          Comments reflect the views and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, kreatli.com shall not be liable for the Comments or for any liability, damages
          or expenses caused and/or suffered as a result of any use of and/or posting of and/or appearance of the
          Comments on this website.
        </p>

        <p className="text-foreground-500 mb-2">
          kreatli.com reserves the right to monitor all Comments and to remove any Comments which can be considered
          inappropriate, offensive or causes breach of these Terms and Conditions.
        </p>

        <p className="text-foreground-500 mb-2">You warrant and represent that:</p>
        ...
        <p className="text-foreground-500 mb-2">
          You hereby grant kreatli.com a non-exclusive license to use, reproduce, edit and authorize others to use,
        ...
        <p className="text-foreground-500 mb-2">
          ...
          kreatli.com; and (d) the link is in the context of general resource information.
        </p>
        ...
        <p className="text-foreground-500 mb-2">
          ...
          you must inform us by sending an e-mail to kreatli.com. Please include your name, your organization name,
        ...
        <p className="text-foreground-500 mb-2">Approved organizations may hyperlink to our Website as follows:</p>
        ...
        <p className="text-foreground-500 mb-2">
          No use of kreatli.com&apos;s logo or other artwork will be allowed for linking absent a trademark license
          agreement.
        </p>

        <h2 className="text-xl font-semibold mt-4 mb-2">iFrames</h2>
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">Content Liability</h2>
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">Reservation of Rights</h2>
        ...
        <h2 className="text-xl font-semibold mt-4 mb-2">Removal of links from our website</h2>
