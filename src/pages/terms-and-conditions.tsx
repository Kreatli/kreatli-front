    ...
    <>
      ...
      <div className="max-w-screen-lg mx-auto px-6">
        ...
        <p className="text-foreground-500 mb-2">
          ...
          use of kreatli.com&apos;s Website, located at kreatli.com
        </p>

        <p className="text-foreground-500 mb-2">
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Kreatli if you do not agree to take
        ...
        <p className="text-foreground-500 mb-2">
          ...
          subject to, prevailing law of pl. Any use of the above terminology or
        ...
        <p className="text-foreground-500 mb-2">
          We employ the use of cookies. By accessing Kreatli, you agreed to use
          cookies in agreement with the kreatli.com&apos;s Privacy Policy.{' '}
        </p>
        ...
        <p className="text-foreground-500 mb-2">
          Unless otherwise stated, kreatli.com and/or its licensors own the
          intellectual property rights for all material on Kreatli. All
          intellectual property rights are reserved. You may access this from
          Kreatli for your own personal use subjected to restrictions set in
        ...
        <p className="text-foreground-500 mb-2">
          ...
          kreatli.com does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of kreatli.com,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, kreatli.com
        ...
        <p className="text-foreground-500 mb-2">
          kreatli.com reserves the right to monitor all Comments and to remove
        ...
        <p className="text-foreground-500 mb-2">
          You hereby grant kreatli.com a non-exclusive license to use,
        ...
        <p className="text-foreground-500 mb-2">
          ...
          the hyperlink compensates the absence of kreatli.com; and (d) the link
        ...
        <p className="text-foreground-500 mb-2">
          ...
          sending an e-mail to kreatli.com. Please include your name, your
        ...
        <p className="text-foreground-500 mb-2">
          No use of kreatli.com&apos;s logo or other artwork will be allowed for
