...
const getHeaders = () => {
  ...
  const token = 'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY1NjIxNjQxNzliOTBiMDc3YmM1NjE4NSIsImlhdCI6MTcwMDk5NzcyNH0._ggdcvVyyIrOF7ouQ0APnUQGmRJKUt6XdaJSQGneodA';
