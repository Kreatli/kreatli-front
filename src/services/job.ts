...
export const requestJobOfferComplete = async ([offerId, data]: [Common.Id, Api.PostPayload['/job-offer/:id/complete']]) => {
...
export const requestJobApplicationCreation = async ([id, data]: [Common.Id, Api.PostPayload['/job-offer/:id/application']]) => {
