...
Discord groups offer:

- **Instant access** to editors hanging out in the same channels as creators
- **Informal pricing** negotiated in DMs
- **Community vibe** — feedback, referrals, and shared resources
- **No platform fees** on paper

For early-stage creators experimenting with clips, Discord feels like the path of least resistance.

## The problems Discord does not solve

### No accountability

Payments often happen off-platform. If an editor ghosts, delivers late, or disappears with a deposit, there is rarely a dispute process.

### No structured hiring

Job details live in scattered messages. Revision rounds, file handoff, and deadlines are managed in DMs — easy to lose track of.

### Scams and low trust

"DM me for cheap edits" posts attract both talented clippers and bad actors. New creators cannot easily verify portfolios or completion history.
...
Discord remains useful for:

- Networking and learning from other clippers
- Getting feedback on a test clip before hiring
- Communities built around a specific creator or niche

But for **repeatable hiring**, a marketplace beats hoping the right editor is online when you post.
