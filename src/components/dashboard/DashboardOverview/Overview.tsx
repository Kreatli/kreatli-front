...
export const Overview = () => {
  ...
  const isLastTier = CURRENT_USER_CURRENT_TIER > 4;
  ...
  return (
    <Card>
      <CardBody className="gap-5">
        ...
        <div>
          {isLastTier ? (
            <div className="text-small text-default-400 mb-1">Earned points: <span className="text-foreground font-semibold">{CURRENT_USER_POINTS}</span></div>
          ) : (
            <>
          ...
          {!isLastTier && (
            <>
              ...
              <div className="flex-1 flex items-center justify-end gap-1">
                ...
                <span
                  className={`flex items-center text-${TIER_COLORS[CURRENT_USER_CURRENT_TIER + 1]}-500 font-semibold`}
                >
