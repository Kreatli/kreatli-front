      ...
      <CardHeader className="flex justify-between">
        ...
        <div className="flex gap-2">
          <ProfileUnverifiedTooltip>
            <Button aria-label="Accept invitation" isIconOnly radius="full" isDisabled={isLoading || !currentUser?.isVerified} color="secondary" onClick={handleAccept}>
              <Icon icon="check" />
            </Button>
          </ProfileUnverifiedTooltip>
          <ProfileUnverifiedTooltip>
            <Button aria-label="Reject invitation" isIconOnly radius="full" variant="flat" isDisabled={isLoading || !currentUser?.isVerified} color="secondary" onClick={handleReject}>
              <Icon icon="cross" />
            </Button>
          </ProfileUnverifiedTooltip>
        </div>
