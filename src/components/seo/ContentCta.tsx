...
export const ContentCta = ({ type, funnelSide }: Props) => {
  ...
  const description = isClipperFocused
    ? 'Create your clipper profile on Kreatli Marketplace and start applying to clipping jobs from creators who need short-form editors.'
    : 'Post a clipping job on Kreatli Marketplace and connect with vetted editors who specialize in short-form content.';
