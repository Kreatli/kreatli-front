...
import { requestChatMessagesRead } from '../../../../services/marketplace/chat';
...
export const ChatMessages = () => {
  const { hasMoreMessages, isLoadingMessages, isLoadingMoreMessages, loadMoreMessages, messages, participantId } =
  ...
  if (messages.length === 0) {
    return <EmptyState title="Send your first message" text="Send your first message to start a conversation" />;
  }
