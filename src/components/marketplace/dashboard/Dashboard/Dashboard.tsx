...
import { DashboardContextProvider } from '../../../../contexts/marketplace/Dashboard';
...
export const Dashboard = () => {
  ...
  const tasksMinHeight = !isMobile ? '20rem' : undefined;

  const boardMinHeight = !isMobile ? `calc((${tasksMinHeight} + ${tiersHeight}px) - ${overviewHeight}px)` : undefined;
