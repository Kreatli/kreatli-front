...
import { requestLikePostComment } from '../../../../services/marketplace/feed';
  ...
  return (
    <div className="flex flex-col gap-3 items-start border-b-1 border-default-200 pb-4 mb-4 last:border-none last:pb-0 last:mb-0">
      <div className="w-full flex items-center justify-between">
        <User
          as={NextLink}
          href={`/marketplace/profile/${authorId}`}
          name={userName}
      ...
      <div className="flex gap-2 w-full">
        <div className="flex-1 flex flex-col gap-2">
          ...
          <Link
            ...
            onClick={() => replyToComment(parentCommentId ?? commentId, authorName)}
          >
        ...
        <Button
          size="sm"
          variant="light"
          className={`text-default-300 hover:text-red-500 ${isLiked ? 'text-red-500' : ''}`}
          onClick={toggleLike}
        >
