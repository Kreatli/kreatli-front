...
import { requestJobApplicationAccept, requestJobApplicationReject } from '../../../../services/marketplace/job';
      ...
      <Popover isOpen={isRejectConfirmationOpen} onOpenChange={setIsRejectConfirmationOpen}>
        <PopoverTrigger>
          <Button
            ...
            radius="lg"
            variant="flat"
            startContent={<Icon icon="crossCircle" size={18} />}
          >
            Reject
          </Button>
        </PopoverTrigger>
        <PopoverContent>
          <div className="py-2">
            ...
            <div className="flex gap-2 mt-2">
              ...
              <Button isLoading={isRejecting} size="sm" variant="flat" color="danger" onClick={handleReject}>
                Reject
              </Button>
            </div>
          </div>
          ...
          <div className="py-2">
            ...
            <div className="flex gap-2 mt-2">
              <Button
                ...
                size="sm"
                variant="light"
                onClick={() => setIsAcceptConfirmationOpen(false)}
              >
                Cancel
              </Button>
              <Button isLoading={isAccepting} size="sm" variant="flat" color="success" onClick={handleAccept}>
                Hire
              </Button>
            </div>
          </div>
